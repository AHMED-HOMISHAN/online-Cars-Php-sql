<?php
	...
	{	
		...
		if(isset($_POST['update']))
		{
			...
			$sql="update vechiles set Vimage1=:vimage1 where id=:id";
										...
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<?php 
														$id=intval($_GET['imgid']);
														$sql ="SELECT Vimage1 from vechiles where vechiles.id=:id";
														$query = $connecting -> prepare($sql);
														$query-> bindParam(':id', $id, PDO::PARAM_STR);
														$query->execute();
													...
													?>
													<div class="col-sm-8">
														<img src="../image/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
													</div>
													<?php }}?>
												</div>
												<div class="form-group">
