...
$sql="update vechiles set Vimage4=:vimage where id=:id";
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage4 from vechiles where vechiles.id=:id";
$query = $connecting -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="../image/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
