...
(function ($) {
        ...
        previewCache = {
            ...
            get: function (id, i, isDisabled) {
                ...
                if (!isEmpty(config) && !isEmpty(config.frameAttr)) {
                    $tmp = $(document.createElement('div')).php(out);
    ...
    FileInput.prototype = {
        ...
        setProgress: function (p) {
            ...
            if (!isEmpty(template)) {
                self.$progress.php(template.repl('{percent}', pct));
            }
        },
        upload: function () {
        ...
        showFolderError: function (folders) {
            ...
            $error.php(self.msgFoldersNotAllowed.repl('{n}', folders));
            $error.fadeIn(800);
            addCss(self.$container, 'has-error');
        ...
        readFiles: function (files) {
            ...
            function readFile(i) {
                ...
                if ($preview.length > 0 && FileReader !== undefined) {
                    $status.php(msgLoading.replace('{index}', i + 1).replace('{files}', numFiles));
